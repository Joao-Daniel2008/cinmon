...
goku = funcoes_Classes.Cimons('goku', 'lutador', imagens['goku']['imagemc'], imagens['goku']['imagemf'], imagens['goku']['mini'], 12, 12, 12, 1, 0, {'ataque1':investida, 'ataque2':kamehameha}, [0, bater, 0, 0, carregar], [gokussj, 6], 1.1)
...
cimons = [lupi, rayquaza, gokussj, goku, rath, mewtwo, mclovin, homelander]